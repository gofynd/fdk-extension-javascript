...
To call platform api you need to have instance of `PlatformClient`. This instance holds methods for SDK classes. All routes registered under `apiRoutes`, express router will have `platformClient` under request object which is instance of `PlatformClient`.
